...
parser.add_argument('--load-path', default=r'C:\Users\33037\Desktop\研究生论文\AT-DGNN-main\example') # change this
parser.add_argument('--gpu', type=int, default=0)
parser.add_argument('--mixed-precision', type=int, default=0)
######## Model Parameters ########
parser.add_argument('--model', type=str, default='BHTMNet')
